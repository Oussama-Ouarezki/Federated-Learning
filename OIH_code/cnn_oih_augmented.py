...
# Configuration
DATA_DIR = '/home/oussama/Desktop/MLA2/OIH_code/INVERTED'  # Use ORIGINAL non-augmented data
BATCH_SIZE = 32
LEARNING_RATE = 0.001
EPOCHS = 15
...
def main():
    print("\n" + "="*80)
    print("ARABIC LETTER TRAINING - NO HORIZONTAL FLIP")
    print("="*80)
    print("1. Load original (non-augmented) dataset")
    ...
    print("✓ Test set uses original non-augmented images\n")
    ...
    print("="*80)
    print("ARABIC LETTER TRAINING Strategy:")
    print("  - Created separate dataset instances for train/test")
    print("  - Training: Augmented data (rotation, translation, scale, shear)")
    print("  - Training: NO horizontal flip (preserves Arabic orientation)")
    print("  - Testing: Original non-augmented data")
    print("\nGenerated files:")
    print("  - training_metrics.png (Loss & Accuracy plots)")
    print("  - confusion_matrix.png (Detailed confusion matrix)")
    print("  - per_class_accuracy.png (Per-class accuracy)")
