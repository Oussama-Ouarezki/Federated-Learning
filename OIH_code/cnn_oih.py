...
class OIH_CNN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.features = nn.Sequential(
            # Block 1
            # Change input channels from 3 to 1 for grayscale
...
def train_model(model, train_loader, val_loader, criterion, optimizer, scheduler, epochs=10):
    ...
    for epoch in range(epochs):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), 'best_model_grayscale.pth')
...
def plot_metrics(train_losses, train_accs, val_losses, val_accs):
    ...
    plt.tight_layout()
    plt.savefig('training_metrics_grayscale.png', dpi=300, bbox_inches='tight')
    print("✓ Metrics plot saved to 'training_metrics_grayscale.png'")
    plt.close()
...
def plot_confusion_matrix(cm, class_names):
    ...
    plt.title('Confusion Matrix (Grayscale)', fontsize=14, fontweight='bold')
    plt.xticks(rotation=45, ha='right')
    plt.yticks(rotation=0)
    plt.tight_layout()
    plt.savefig('confusion_matrix_grayscale.png', dpi=300, bbox_inches='tight')
    print("✓ Confusion matrix saved to 'confusion_matrix_grayscale.png'")
    plt.close()
...
def main():
    ...
    # No augmentation for validation (grayscale)
    ...
    # Load Dataset
    try:
        # Note: Dataset now loads images as grayscale by default
    ...
    # Load best model
    model.load_state_dict(torch.load('best_model_grayscale.pth'))
    ...
    # Final Evaluation
    print("="*60)
    print("Final Evaluation on Test Set (Grayscale)")
    print("="*60)
